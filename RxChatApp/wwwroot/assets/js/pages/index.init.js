...
!(function () {
    ...
    ($("#copyClipBoard").attr('style', 'display:none')),
        ($("#copyClipBoardChannel").attr('style', 'display:none'));
    function e(e, t) {
    ...
    function o() {
        "users" == m
            ? (($("#channel-chat").attr('style', 'display:none')),
                ($("#channel-chat").attr('style', 'display:block')))
            : (($("#channel-chat").attr('style', 'display:block')),
                ($("#channel-chat").attr('style', 'display:none'))),
            _(s + "chats.json");
    }
    ...
    document.body.addEventListener("click", function () {
        ...
        (document.getElementById("favourite-users")?.addEventListener("click",function () {
            document.getElementById("chat-input").focus();
        })    ),
        (document.getElementById("usersList")?.addEventListener("click", function () {
            document.getElementById("chat-input").focus();
        })),
        (document.getElementById("channelList")?.addEventListener("click", function () {
            document.getElementById("chat-input").focus();
        }));
