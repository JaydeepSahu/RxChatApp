...
export class HttpConnection {
    constructor(url, options = {}) {
        ...
        this.connectionState = 2 /* ConnectionState.Disconnected */;
    ...
    start(transferFormat) {
        ...
        if (this.connectionState !== 2 /* ConnectionState.Disconnected */) {
            return Promise.reject(new Error("Cannot start a connection that is not in the 'Disconnected' state."));
        }
        this.connectionState = 0 /* ConnectionState.Connecting */;
        this.startPromise = this.startInternal(transferFormat);
        return this.startPromise;
    }
    send(data) {
        if (this.connectionState !== 1 /* ConnectionState.Connected */) {
    ...
    async startInternal(transferFormat) {
        ...
        try {
            ...
            this.changeState(0 /* ConnectionState.Connecting */, 1 /* ConnectionState.Connected */);
        }
        catch (e) {
